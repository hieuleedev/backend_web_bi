...
export class PostgresAdapter {
  ...
  async createProduct(data) {
    ...
    const sql = `
      INSERT INTO public.products (
        ...
        buy_price, rent_price_1day, rent_price_3days, rent_price_7days, deposit,
  ...
  async getProductCalendar(productId) {
    const { rows: prodRows } = await this.pool.query(`SELECT id, title, featured_image, deposit, rent_price_1day FROM public.products WHERE id = $1`, [productId]);
